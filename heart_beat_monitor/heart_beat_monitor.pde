...
void setup() 
{
  ...
  size(1200, 600);//screen size setup, display width is read into teh program, and I
...
void serialEvent(Serial myPort) { //this is called whenever data is sent over by the arduino
  ...
  inString = myPort.readStringUntil(lf);//read in the new data, and store in inString
